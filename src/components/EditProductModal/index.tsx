...
export const EditProductModal = () => {
    const { isEditProductOpen, setEditProductOpen } = useContext(ModalContext);
    const [formData, setFormData] = useState({})
 
    return (
        <ReactModal
            isOpen={isEditProductOpen}
            onRequestClose={() => setEditProductOpen(false)}
            style={{
                overlay: {
        ...
        >
            <h2 className="text-center text-xl font-semibold mb-8 font-poppins">Editar Produto</h2>
